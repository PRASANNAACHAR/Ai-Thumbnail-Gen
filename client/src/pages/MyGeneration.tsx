    ...
    <>
      ...
      <div className="mt-32 min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
         ...
         <div className="mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-1">View and manage all ypur AI-generated thumbnails</p>
         </div>
         ...
         {/* grid */}
         {!loading && thumbnails.length > 0 && (
          <div className="columns-1 sm:columns-2 lg:columns-3 2xl:coloumns-4 gap-8">
