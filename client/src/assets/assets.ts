...
// cutomised for me
export const thumbnailStyles = [ "Bold & Graphic",
  "Minimalist",
  "Photorealistic",
  "Illustrated",
  "Tech/Futuristic",
...
export const colorSchemes = [
    ...
    { id: "pastel", name: "Pastel", colors: ["#FFB5A7", "#FCD5CE", "#F8EDEB"] },
     ...
     // Gaming extra nan hakid 👇
  { id: "gaming-red", name: "Gaming Red", colors: ["#FF0000", "#8B0000", "#1A1A1A"] },
  { id: "gaming-blue", name: "Gaming Blue", colors: ["#00A8FF", "#0066FF", "#001F54"] },
  { id: "gaming-green", name: "Gaming Green", colors: ["#39FF14", "#00C853", "#0B3D0B"] },
  { id: "cyberpunk", name: "Cyberpunk", colors: ["#FF00FF", "#00E5FF", "#1A001A"] },
  { id: "fire", name: "Fire", colors: ["#FF4500", "#FF8C00", "#FFD700"] },
  { id: "ice", name: "Ice", colors: ["#E0F7FA", "#81D4FA", "#0288D1"] },
  { id: "gold", name: "Gold", colors: ["#FFD700", "#FFC107", "#8D6E00"] },
  { id: "royal", name: "Royal", colors: ["#3F51B5", "#673AB7", "#EDE7F6"] },
  { id: "toxic", name: "Toxic", colors: ["#AEEA00", "#64DD17", "#263238"] },
  { id: "blood", name: "Blood", colors: ["#8B0000", "#B71C1C", "#000000"] },
  { id: "galaxy", name: "Galaxy", colors: ["#4A148C", "#283593", "#90CAF9"] },
  { id: "retro", name: "Retro", colors: ["#FFB703", "#FB8500", "#023047"] },
